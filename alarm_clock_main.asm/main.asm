...
turn_off_digit:
    sbrs r22, 0	; if r22 bit 0 is set:
    cbi PORTB, D1	;     set D1 high 
    sbrs r22, 1	; if r22 bit 1 is set:
    cbi PORTB, D2	;     set D2 high
    sbrs r22, 2	; if r22 bit 2 is set:
    cbi PORTB, D3	;     set D3 high
    sbrs r22, 3	; if r22 bit 3 is set:
    cbi PORTB, D4	;     set D4 high    
